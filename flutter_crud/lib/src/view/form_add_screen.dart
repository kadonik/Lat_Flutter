...
import 'package:flutter_crud/src/service/api_profile.dart';
...
class _FormAddScreenState extends State<FormAddScreen> {
  ...
  ApiProfile _apiProfile = ApiProfile();
                ...
                Padding(
                  ...
                  child: RaisedButton(
                    ...
                    onPressed: () {
                      ...
                      if (widget.profile == null) {
                        _apiProfile.createProfile(profile).then((isSuccess) {
                        ...
                        _apiProfile.updateProfile(profile).then((isSuccess) {
                          setState(() => _isLoading = false);
                          if (isSuccess) {
                            Navigator.pop(_scaffoldState.currentState.context);
                          } else {
